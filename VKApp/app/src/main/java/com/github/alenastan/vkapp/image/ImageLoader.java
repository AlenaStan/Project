package com.github.alenastan.vkapp.image;
...
import com.github.alenastan.vkapp.os.assist.LIFOLinkedBlockingDeque;
import com.github.alenastan.vkapp.prosessing.BitmapProcessor;
import com.github.alenastan.vkapp.prosessing.Processor;
import com.github.alenastan.vkapp.sourse.DataSource;
...
public class ImageLoader {
    ...
    private DataManager.ImageLoader<Bitmap, InputStream, String> mLoader;
    ...
    public ImageLoader(Context context, DataSource<InputStream, String> dataSource, Processor<Bitmap, InputStream> processor) {
        ...
        this.mLoader = new DataManager.ImageLoader<Bitmap, InputStream, String>() {
