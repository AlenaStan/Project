package com.github.alenastan.vkapp.helper;

import android.os.Handler;

import com.github.alenastan.vkapp.os.AsyncTask;
...
public class DataManager {
    ...
    loadData(
            ...
            final DataSource<DataSourceResult, Params> dataSource,
            final Processor<ProcessingResult, DataSourceResult> processor,
            final ImageLoader<ProcessingResult, DataSourceResult, Params> mySuperLoader) {
        if (callback == null) {
