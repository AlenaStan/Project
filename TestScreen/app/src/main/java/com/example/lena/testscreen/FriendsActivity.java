...
import com.example.lena.testscreen.process.BitmapProcessor;
import com.example.lena.testscreen.process.FriendArrayProcessor;
                ...
                mAdapter = new ArrayAdapter<Friend>(this, R.layout.adapter_item, android.R.id.text1, data) {
                    ...
                    public View getView(int position, View convertView, ViewGroup parent) {
                        ...
                        if (!TextUtils.isEmpty(url)) {
                            ...
                            }, url, CachedHttpDataSource.get(FriendsActivity.this), new BitmapProcessor());
                        }
                        return convertView;
                    }
